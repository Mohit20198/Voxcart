...
const PERMANENT_IMAGES: Record<string, string> = {
  // DAIRY
  'Amul Toned Milk, 500ml':         'https://images.unsplash.com/photo-1550583724-b2692b85b150?w=400&q=80',
  'Amul Butter, 100g':              'https://images.unsplash.com/photo-1589985270826-4b7bb135bc9d?w=400&q=80',
  'Amul Cheese Slices, 10pc':       'https://images.unsplash.com/photo-1486297678162-eb2a19b0a318?w=400&q=80',
  ...
  // BAKERY
  'Britannia Bread, 400g':          'https://images.unsplash.com/photo-1549931319-a545dcf3bc73?w=400&q=80',
  'Pav, 6pc':                       'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=400&q=80',
  'Whole Wheat Bread, 400g':        'https://images.unsplash.com/photo-1598373182200-6d93b5e6b985?w=400&q=80',
  'Rusk, 200g':                     'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=400&q=80',

  // SNACKS
  'Parle-G Biscuits, 250g':         'https://images.unsplash.com/photo-1499636027994-c44e0e7b47d4?w=400&q=80',
  ...
  "Haldiram's Bhujia, 200g":        'https://images.unsplash.com/photo-1604085444641-38435d680bc9?w=400&q=80',
  'Britannia Good Day Cookies, 150g':'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=400&q=80',
  "Haldiram's Aloo Bhujia, 150g":   'https://images.unsplash.com/photo-1604085444641-38435d680bc9?w=400&q=80',
  'Maggi Noodles, 280g (4pc)':      'https://images.unsplash.com/photo-1612929633738-8fe44f7ec841?w=400&q=80',
  ...
  'Sooji (Semolina), 500g':         'https://images.unsplash.com/photo-1627572719622-4892c286b1f2?w=400&q=80',
  'Besan (Gram Flour), 500g':       'https://images.unsplash.com/photo-1627572719622-4892c286b1f2?w=400&q=80',
...
async function run() {
  ...
  for (const name of names) {
    const url = PERMANENT_IMAGES[name];
    const slug = name.replace(/ /g, '-').replace(/,/g, '').replace(/\(/g, '').replace(/\)/g, '').replace(/'/g, '').toLowerCase();
    ...
    // Update Firestore to point to local URL
    const barcode = generateBarcode(name);
    try {
      await db.collection('products').doc(barcode).update({ imageUrl: localUrl });
      successCount++;
      process.stdout.write('.');
    } catch (e) {
      console.error(`\nFailed to update DB for ${name}: ${e}`);
    }
  }
  
  console.log(`\nDone! Successfully updated ${successCount}/${names.length} products to use local images.`);
}
